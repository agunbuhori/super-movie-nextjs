...
const MovieItem: React.FC<Movie & Props> = (props): JSX.Element => {
    return (
        <div className="rounded-lg overflow-hidden shadow">
            <a onClick={() => props.showImage(props.Poster)} className="bg-gray-600 h-96 md:h-80 bg-cover block" style={{backgroundImage: `url(${props.Poster !== 'N/A' ? props.Poster : 'https://popcornsg.s3.amazonaws.com/movies/300/1745-10843-LostInHo.png'})`}}></a>
